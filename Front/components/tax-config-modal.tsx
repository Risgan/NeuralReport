      ...
      <div className={cn('grid gap-2', options.length === 3 ? 'grid-cols-3' : 'grid-cols-2')}>
        {options.map((opt) => (
          ...
          >
            ...
            <span className={cn('text-[11px]', value === opt.value ? 'text-primary/70' : 'text-muted-foreground/60')}>
              {opt.description}
            </span>
          </button>
        ))}
      ...
      {open && (
        ...
        >
          <div className="w-full max-w-md rounded-2xl border border-border bg-card shadow-2xl shadow-black/40 overflow-hidden">
              ...
              <div className="flex flex-col gap-4">
                ...
                <ModeToggle
                  ...
                  options={[
                    {
                      value: 'unit',
                      label: 'Por dias activos',
                      description: 'Precio × Dias Activos',
                    },
                    {
                      value: 'flat',
                      label: 'Valor fijo',
                      description: 'Mismo precio por tienda',
                    },
                    {
                      value: 'none',
                      label: 'No aplicar',
                      description: 'Ocultar columna importe',
                    },
                  ]}
                />
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <ModeToggle
                  ...
                  options={[
                    ...
                    },
                    {
                      ...
                      description: 'No afecta el total',
                    },
                  ]}
                />
                <ModeToggle
                  ...
                  options={[
                    {
                      value: 'deduct',
                      label: 'Descontar',
                      description: '- ReteFuente - ReteICA',
                    },
                    {
                      value: 'none',
                      label: 'Solo informativo',
                ...
                <div className="rounded-xl border border-border bg-surface px-4 py-3">
                  <p className="text-xs text-muted-foreground mb-1.5 flex items-center gap-1.5">
                    <Info className="w-3 h-3" /> Formula resultante
                  </p>
            ...
            {/* Footer */}
            <div className="flex items-center justify-between px-6 py-4 border-t border-border bg-surface-raised">
              <button
                onClick={handleReset}
